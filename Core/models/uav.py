...
class UAV(models.Model):
    ...
    last_longitude = models.DecimalField(max_digits=12, decimal_places=8, null=True, blank=True)
    last_latitude = models.DecimalField(max_digits=12, decimal_places=8, null=True, blank=True)
    lease_disabled = models.BooleanField(default=False)
    brand = models.CharField(max_length=255)
    model = models.CharField(max_length=255)
    weight = models.FloatField()
    takeoff_weight = models.FloatField()
    flight_range = models.DecimalField(max_digits=12, decimal_places=8, null=True, blank=True)
